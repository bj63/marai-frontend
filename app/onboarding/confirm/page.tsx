    ...
    <>
      <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden">
        ...
        <header className="flex items-center bg-background-light dark:bg-background-dark p-4 pb-2 justify-between sticky top-0 z-10">
          <button className="text-white flex size-12 shrink-0 items-center justify-center" type="button">
          ...
          <div className="flex w-12 items-center justify-end">
            <p className="text-primary/80 text-base font-bold leading-normal tracking-[0.015em] shrink-0">Skip</p>
          </div>
        </header>
        <main className="flex-grow px-4">
          ...
          <section className="mt-6">
            ...
            <div className="mb-6">
              ...
              <input
                className="confirm-slider w-full h-2 rounded-full appearance-none cursor-pointer"
                id="empathy"
                max="100"
                min="0"
                type="range"
      ...
      <style jsx global>{`
        .confirm-slider::-webkit-slider-thumb {
          ...
          width: 24px;
          height: 24px;
          background-color: #f425af;
          border-radius: 9999px;
          cursor: pointer;
          margin-top: -8px;
          border: 4px solid #22101c;
        }
